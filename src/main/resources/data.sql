-- Productdata overgenomen uit uitwerkingen
...
VALUES (1001, 'NH3216SMART', 'AAA', 'Nikkei HD smart TV controller', 'Nikkei', 12.99, 235885),
       ...
       (1004, 'Philips', 'AA', 'NHAJ3479', 'Philips', 35, 5);
...
-- Wachtwoord moet nog encrypted
INSERT INTO users (username, password, email, enabled)
VALUES ('Marjet', 'password1','marjet@techiteasy.nl', TRUE),
       ('Rieneke', 'password2', 'rieneke@techiteasy.nl', TRUE),
       ('Hannah', 'password3', 'hannah@techiteasy.nl', TRUE);

INSERT INTO authorities (username, authority)
VALUES ('Marjet', 'ROLE_ADMIN'),
       ('Rieneke', 'ROLE_USER'),
       ('Hannah', 'ROLE_USER');
